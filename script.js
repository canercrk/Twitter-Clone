...
const middleContent = document.querySelector(".middle-content"); //then attach to it eventListener
...
middleContent.addEventListener("click", (e) => {
    // there is e because we have 2 arguments
    if (e.target.classList[1] === "main-btn") {
        //Click the buttons and therefore we have to call function and execute the block of code
        goToLoginPage();
    }
});
...
btnTop.addEventListener("click", () => {
    ...
    if (inputUserInfo.value !== "" && inputUserPassword.value !== "") {
        ...
        goToLoginPage();
        loginModel.style.display = "block"; /*error message*/
    }
});
